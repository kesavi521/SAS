...
.main
		...
		function myFunction() {
  var txt;
  var r = confirm("Assigned Successfully");
  if (r == true) {
    txt = "You pressed OK!";
  }
...
<body>
	...
	<div class="main">
            <center>
                <form   action="AssignedOrders" method="post" onsubmit="return myFunction();">
		...
		try
		{
			...
			if(request.getParameter("edit")!=null) 
			{
				...
				pstmt=con.prepareStatement("select * from Approvedorders where pid=?"); // sql select query
			...
			<tr>
				<td><input type="submit" name="btn_update" value="Assign" ></td>	
			</tr>
		...
		<center>
				<h1><a href="ViewApprovedOrders.jsp">Back</a></h1>
		</center>
