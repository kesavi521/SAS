...
.main
		...
		function myFunction() {
  var txt;
  var r = confirm("Approved Successfully");
  if (r == true) {
    txt = "You pressed OK!";
  }
...
<body>
	...
	<div class="main">
            <center>
                <form   action="ApprovedOrders" method="post" onsubmit="return myFunction();">
    ...
    if(session.getAttribute("check")!=null){
        name=(String) session.getAttribute("orderid");
    }
			...
			if(request.getParameter("edit")!=null) 
			{
				...
				pstmt=con.prepareStatement("select * from userorders where orderid=?"); // sql select query
			...
			<tr>
				<td><input type="submit" name="btn_update" value="Approve" ></td>	
			</tr>
		...
		<center>
				<h1><a href="Vieworders.jsp">Back</a></h1>
		</center>
