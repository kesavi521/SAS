...
{	
	...
	if(request.getParameter("delete")!=null)
	{
		...
		pstmt=con.prepareStatement("delete from Employees where name=? "); //sql delete query
...
<body>
		...
		{	
			...
			pstmt=con.prepareStatement("select * from Employees"); //sql select query  
		...
		%>
				<tr>
					...
					<td><%=rs.getString(3)%></td>
                                        ...
                                        <td><a href="updateEmployee.jsp?edit=<%=rs.getString(1)%> " target="_self">Update</a></td>
